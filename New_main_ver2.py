...
parser.add_argument('test_file',help='test_file')
...
def from_test(f_path):
  ...
  return len(df_valid), len(df_test)
...
if __name__ == '__main__':
    ...
    train_num = from_train(TRAIN_tsv)
    valid_num, test_num = from_test(TEST_tsv)
